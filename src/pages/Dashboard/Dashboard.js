...
import getDashboardData from "../../sdk/getDashboardData";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.log(data);
        await setDashboardData(data.data);
      } catch (error) {
        console.log(error);
      }
    })();
    ...
    return (
      <div>
            ...
            <div className=" flex items-center mt-4 ml-4">
              ...
              <div className="ml-4">
                ...
                <h1 className="text-2xl font-bold">
                  ₹ {dashboardData.total ? dashboardData.total.deposit : 0}
                </h1>
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white h-48 w-72 rounded-xl relative scale-125 ml-16">
            <div className=" flex items-center mt-4 ml-4">
              ...
              <div className="ml-4">
                ...
                <h1 className="text-2xl font-bold">
                  ₹ {dashboardData.total ? dashboardData.total.withdraw : 0}
                </h1>
              </div>
              <div className="ml-4">
        ...
        <div className="h-[22rem] flex justify-around items-center mt-12">
          ...
          <div className="bg-white mt-12 h-[400px] w-5/12 rounded-md p-1 ">
            <h1 className="font-bold pt-4 pl-4 text-lg">Accounts</h1>
            <AccountsChart result={dashboardData.accounttype} />
          </div>
        </div>
      </div>
    );
